...
class GaussianSmoothing(nn.Module):
    def __init__(self, channels, kernel_size, sigma, dim=2):
        ...
        input using a depth-wise convolution. 
        
        https://discuss.pytorch.org/t/is-there-anyway-to-do-gaussian-filtering-for-an-image-2d-3d-in-pytorch/12351

        :param channels: int
            Number of channels of the input tensors. Output will have this number of channels as well.
    ...
    def forward(self, input):
        ...
        """
        return self.conv(input, weight=self.weight, groups=self.groups, padding=(self.kernel_size - 1) // 2)
